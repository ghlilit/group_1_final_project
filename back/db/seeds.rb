...
User.create([
    ...
    {fname: "User", lname: "Useryan", email:"user.useryan2@gmail.com", role:"premium", password:"seedpassword", password_confirmation:"seedpassword", desk_id: 1},
    ...
    {fname: "User", lname: "Useryan", email:"user.useryan4@gmail.com", role:"regular", password:"seedpassword", password_confirmation:"seedpassword", desk_id: 2},
    {fname: "User", lname: "Useryan", email:"user.useryan5@gmail.com", role:"regular", password:"seedpassword", password_confirmation:"seedpassword", desk_id: 3}
])
